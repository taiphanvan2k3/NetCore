...
namespace ExternalAuthentication.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            // Sẽ kiểm tra xem trong bảng AspNetUserLogins có tồn tại thông tin login của user này chưa
            // Nếu có thì result.Succeeded = true và sẽ được chuyển hướng đến trang chủ
